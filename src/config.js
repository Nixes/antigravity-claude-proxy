...
const DEFAULT_CONFIG = {
    ...
    forceGoogleSearch: false, // Force enable Google Search grounding for all supported models
...
function loadConfig() {
    try {
        ...
        if (process.env.FORCE_GOOGLE_SEARCH === 'true') config.forceGoogleSearch = true;
